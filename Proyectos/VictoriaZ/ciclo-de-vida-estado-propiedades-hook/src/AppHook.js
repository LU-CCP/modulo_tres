...
const App=()=>{ 
    ...
    const handleHide=useCallback(()=> {  /// se recrea solo cuando cambia algo de lo q se le pasa
        setShowInstructions(false);
        } )
     
    return( //{showInstructions && <Instructions />}  primera if segunda retorno, cuando showInstructions es true hace lo sgdo sino sigue de largo
        <div className="App">
