...
const App=()=>{ //estados ya no se usan como objetos, sino q como variables individuales
    ...
    useEffect(()=> { //solo cuando value cambia
        console.log('componentDidUpdateValue', value)
    },[value])

    return( //equivalente al render, copiar aqui lo del render en App.js
        <div className="App">
